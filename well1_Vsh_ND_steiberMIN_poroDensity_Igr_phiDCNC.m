...
layer1_min=2605, layer1_max=2780;
...
Rt=R0, Rw=0.0395, Rsh=1.2218,Rmf=0.0359;
...
if ((Igr1(i) < 0.45 & Igr1(i)>0.25) & (phiE1(i)>0.03 & phiE1(i)<0.16) &(Sw1(i)>0.3 & Sw1(i)<0.7))
Igr1I(i)=Igr1(i);
phiE1I(i)=phiE1(i);
Sw1I(i)=Sw1(i);
MD1I(i)=MD(i);
...
if ((Igr2(i) < 0.45 & Igr2(i)>0.25) & (phiE2(i)>0.03 & phiE2(i)<0.26) &(Sw2(i)>0.3 & Sw2(i)<0.7))
Igr2I(i)=Igr2(i);
phiE2I(i)=phiE2(i);
Sw2I(i)=Sw2(i);
MD2I(i)=MD(i);
...
i=i+1;
%HIIP2=8*(layer2_max-layer2_min)*(F2/F22)*mean(phiE2(i))*mean((1-Sw2(i)))/2.23;
end
...
if ((Igr3(i) < 0.45 & Igr3(i)>0.35) & (phiE3(i)>0.03 & phiE3(i)<0.36) &(Sw3(i)>0.3 & Sw3(i)<0.7))
Igr3I(i)=Igr3(i);
phiE3I(i)=phiE3(i);
Sw3I(i)=Sw3(i);
MD3I(i)=MD(i);
