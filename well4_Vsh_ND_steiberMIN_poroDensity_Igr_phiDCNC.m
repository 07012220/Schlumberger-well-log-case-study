...
layer1_min=2605, layer1_max=2824.1;
layer2_min=2824.2, layer2_max=3986.1;
layer3_min=4394.6, layer3_max=4504.9;

GR_max=179.096, GR_min=0.056;
phi_nsh=0.389;phi_dsh=0.152;
phi_M1=2.65,phi_M2=2.6,phi_F=1;
DT_m=55.5,DT_f=189;

R0=0.287, m=1.9, a=0.8;
Rt=R0, Rw=0.042, Rsh=2.081, Rmf=0.0469;
