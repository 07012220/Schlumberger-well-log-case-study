...
layer1_min=2605, layer1_max=2771.2;
layer2_min=2771.2, layer2_max=3104;
layer3_min=3455, layer3_max=3607.3;

GR_max=126.8953, GR_min=0.0704;
phi_nsh=0.2546;phi_dsh=0.018;
phi_M1=2.65,phi_M2=2.6,phi_F=1;
DT_m=55.5,DT_f=189;

R0=0.371, m=1.9, a=0.8;
Rt=R0, Rw=0.039, Rsh=2.278,Rmf=0.04;
